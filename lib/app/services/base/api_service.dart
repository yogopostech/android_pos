...
class ApiService {
  ...
  Future<BaseModel> _makeRequest(String url, dynamic data, HttpMethod method,
      {String contentType = 'application/json',Map<String, dynamic>? queryParameters}) async {
    try {
  ...
  Future<BaseModel> makePostRequest(
    ...
    return _makeRequest(url, data,queryParameters:queryParameters, HttpMethod.post);
  }
