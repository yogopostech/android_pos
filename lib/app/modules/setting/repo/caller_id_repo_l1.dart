...
//         PopupDialog.showSuccessDialog("L1 Serial port opened successfully.");
...
//                 // ! save the data
//                 CallerIdController.to.callerNameL1 = callerInfo["Name"] ?? "";
//                 CallerIdController.to.callerNumberL1 =
//                     callerInfo["Number"] ?? "";
...
//     try {
//       port?.close();
//       PopupDialog.showErrorMessage("L1 Serial port closed.");
//     } catch (e) {
