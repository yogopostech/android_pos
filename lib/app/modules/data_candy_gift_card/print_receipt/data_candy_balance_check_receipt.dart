...
Future<pw.Widget> dataCandyCheckBalancePrintReceipt(
    ) async {
...
// Inside your PDF build:
      ...
      pw.Text(
        DateFormat('MMM dd, yyyy,  hh:mm a')
            .format(DateTime.now().toTimeZone()),
        style: bodyStyle,
      ),
      ...
      pw.Row(
          ...
          children: [
            ...
            pw.Text("Server: ${controller.checkBalanceModel.value?.data?.employeeFirstName}", style: bodyStyle),
      ...
      pw.Row(
        children: [
          ...
          pw.Expanded(
              child: pw.Text(
                maskCardNumber(controller.checkBalanceModel.value?.data?.cID ?? ""),
                style: bodyStyle,
      ...
      pw.Row(
        children: [
          ...
          pw.Expanded(
              child: pw.Text(
                "\$${(controller.checkBalanceModel.value?.data?.balance == null)
                    ? "0.00"
                    : controller.checkBalanceModel.value?.data?.balance?.toStringAsFixed(2)}",
                style: bodyStyle,
                textAlign: pw.TextAlign.right,
              )),
        ],
      ...
      pw.Row(
        children: [
          ...
          pw.Expanded(
              child: pw.Text(
                controller.checkBalanceModel.value?.data?.rawResponse?.tCN ?? "",
                style: bodyStyle,
                textAlign: pw.TextAlign.right,
              )),
        ],
