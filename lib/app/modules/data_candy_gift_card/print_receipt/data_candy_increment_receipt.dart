...
Future<pw.Widget> dataCandyIncrementPrintReceipt(
DataCandyCardReloadModel data,{String? server}
) async {
  ...
  pw.Row(
      ...
      pw.Row(
        ...
        children: [
          ...
          pw.Text(maskCardNumber(data.cID ?? ""),
              style: bodyStyle),
        ],
      ),
      pw.SizedBox(height: 3),
      ...
      pw.Row(
        mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
        children: [
          pw.Text("DC Gift Card Recharge", style: bodyStyle),
          // pw.Text("${increment.data?.increment?.aMT ?? ""}", style: boldStyle),
          pw.Text("\$${data.aMT?.toStringAsFixed(2)}", style: bodyStyle),
        ],
      ),
      pw.SizedBox(height: 3),
      ...
      pw.Row(
        ...
        children: [
          ...
          pw.Text(data.iNV ?? "", style: bodyStyle),
        ],
      ),
      pw.SizedBox(height: 3),
      ...
      pw.Row(
        ...
        children: [
          ...
          pw.Text(data.tCN ?? "", style: bodyStyle),
        ],
      ),
      pw.SizedBox(height: 3),
      ...
      pw.Row(
        ...
        children: [
          ...
          pw.Text("\$${data.balance?.toStringAsFixed(2)}", style: pw.TextStyle(
