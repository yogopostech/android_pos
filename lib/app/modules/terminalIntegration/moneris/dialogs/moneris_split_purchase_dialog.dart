            ...
            if (res2.receipt.statusCode == "5207") {
              ...
              if (widget.isSplitOrder) {
                ...
                SplitOrderController.to.splitAmountChecks
                    .splitAmounts[widget.index].payment = paymentModel;
                ...
                if (widget.isOrderPrint) {
                  ...
                  await PrintUtils().directPrint(
                    data: escSplitAmountPrintReceipt(
                      isCustomerCopy: true,
                      order: SplitOrderController
                          .to.splitAmountChecks.splitAmounts[widget.index],
                    ),
                    printer: printerName,
                  );
                }

                //todo: update split Amount
                DataUpdateHelper.getDataByCheckType();
              }
