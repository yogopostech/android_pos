...
class _RefundDialogContent extends StatefulWidget {
  ...
  @override
  State<_RefundDialogContent> createState() => __RefundDialogContentState();
}
...
class __RefundDialogContentState extends State<_RefundDialogContent> {
  ...
  Future<void> refundRequest() async {
    ...
    Map<String, dynamic> data = {
      ...
      "polling": "true",
      "postBackUrl": "${URLS.monerisPostBackURL}/${Preferences.stationId}/$resId/$id",
      "dataId": id,
        ...
        "request": [
          {
            ...
            "idempotencyKey": "${widget.orderId}_refund",
            "terminalId": widget.terminalId, //Optional
            if (widget.username != null) "username": widget.username, //Optional
            if (widget.linkId != null) "linkId": widget.linkId, //Optional
            "transactionId": widget.transactionId, //Optional
            "action": "refund",
        ...
        if (fastRes.receipt.statusCode == "5201") {
          ...
          if (res2 != null) {
            if (res2.receipt.statusCode == "5207") {
              onChangeStatusMsg(PurchaseDialogStatus.success,
              ...
              if (widget.isSplitOrder == null) {
                ...
                SplitOrderController.to.splitAmountChecks
                    .splitAmounts[widget.splitIndex ?? 0].refund = true;
                SplitOrderController.to.update();
              }
            } else if (res2.receipt.statusCode == "5202") {
              // Duplicate request that is still in progress
              onChangeStatusMsg(PurchaseDialogStatus.error,
